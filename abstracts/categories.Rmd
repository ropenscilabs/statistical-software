...
5. [`mlr3`](https://joss.theoj.org/papers/10.21105/joss.01903): machine learning, workflow; input: parameters; output: trained ML model
6. [`perccalc`](https://joss.theoj.org/papers/10.21105/joss.01796): categorical variables, estimates; input: data.frame; output: numeric vectors of estimates and errors
...
18. [`modelStudio`](https://joss.theoj.org/papers/10.21105/joss.01798): machine learning, workflow, EDA; input: data.frame, ML data; output: model prediction, visualization
...
23. [`thurstonianIRT`](https://joss.theoj.org/papers/10.21105/joss.01662): latent variables, categorical variables, pairwise comparisons, model probability; input: data.frame, categorical data; output: model estimates, summary stastistics
...
30. [`ccostr`](https://joss.theoj.org/papers/10.21105/joss.01593): non-stationarity, estimates, survival; input: numeric vector; output: first & second-order estimates
...
33. [`survPen`](https://joss.theoj.org/papers/10.21105/joss.01434): survival, regression, parameter estimation, multidimensional model, splines; input: numeric vector; output: numeric vector of modelled estimates
...
47. [`modelDown`](https://joss.theoj.org/papers/10.21105/joss.01444): ML, summary statistics, graphical output; input: arbitrary ML data; output: summary web page
...
66. [`klrfome`](https://joss.theoj.org/papers/10.21105/joss.00722): kernel density, kernel logistic regression, spatial, areal statistics, similarity statistics, focal windows; input: data.frame; output: binary logistic regression statistics
...
82. [`arviz`](https://joss.theoj.org/papers/10.21105/joss.01143): Bayesian, model selection, EDA; input: arbitrary ML data, data.frame; output: summary statistics
...
86. [`iRF`](https://joss.theoj.org/papers/10.21105/joss.01077): random forests, dimensionality reduction; input: arbitrary ML data; output: model estimates
...
96. [`survxai`](https://joss.theoj.org/papers/10.21105/joss.00961): ML, regression, model selection, survival, visualization; input: arbitrary ML data; output: summary statistics, reports
...
102. [`data.adapt.multi.test`](https://joss.theoj.org/papers/10.21105/joss.00161): inference, effect sizes, dimensionality reduction; input: data.frame, arbitrary ML data; output: summary statistics
...
125. [`iml`](https://joss.theoj.org/papers/10.21105/joss.00786): ML, feature selection; input: arbitrary ML data; output: model estimates
127. [`rsimsum`](https://joss.theoj.org/papers/10.21105/joss.00739): Monte Carlo, estimates, simulation; input: data.frame, arbitrary ML data; output: summary statistics, visualization
...
141. [`MCMCvis`](https://joss.theoj.org/papers/10.21105/joss.00640): Monte Carlo, summary statistics; input: data.frame, arbitrary ML data; output: summary statistics
...
cl <- graph_from_data_frame (edges) %>%
    clusters ()
out <- names (cl$membership [which (cl$membership > 1)])
