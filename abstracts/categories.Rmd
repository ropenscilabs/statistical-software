...
166. [`BayesianNetwork`](https://joss.theoj.org/papers/10.21105/joss.00425): Bayesian, networks, ML, wrapper; input: application-specific data format; output: summary statistics, visualization
