...
reach, fairness, representativeness, and other related aspects. It considers
community both in terms of the two distinct aspects of users and contributors to
packages, and developers themselves. The first communities coalesce around
individual packages; the second around rOpenSci itself and its general package
ecosystem.
