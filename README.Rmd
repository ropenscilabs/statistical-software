...
to be *exemplary*. In doing so, it may nevertheless be instructive to consider
...
sub-section the following two, related questions:
...
influence and informed by the peer review process itself.
