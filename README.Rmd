...
process and standards, for which key questions are:
...
implementations can be built."[^1] It will likely be nevertheless important for
the present project to develop some scheme for categorization, particularly
because the set of standards envisioned by this project will be variably
applicable to different categories, and understanding which standards may or
may not apply to a particular piece of software will provide important
...
- **[`gtsummary`](https://github.com/ropensci/software-review/issues/334)**,
  ...
  clearly aimed at enhancing a purely statistical workflow.
...
- **[`modelStudio`](https://joss.theoj.org/papers/10.21105/joss.01798)**,
  ...
  output produced, are purely statistica.
...
-   Who should be in the pool of software reviewers and editors, and how might
    be find and cultivate such a pool?
...
software review [for example, @mili_software_2015;@ammann_introduction_2017]
...
contrasts strongly with the singular nature of review as currently implemented
by rOpenSci. Other systems, such as pull-request reviews or inline systems
(e.g., [watson-ruby](https://github.com/nhmood/watson-ruby)), focus review on
much more granular scales both in terms of the scales of code reviewed and time
frames.
